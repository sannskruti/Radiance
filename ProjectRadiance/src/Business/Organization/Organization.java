...
public abstract class Organization {
    ...
    public enum Type{
        Admin("Admin"),
        EnergyOrganization("Energy Organization"),
        ...
        MaterialSupplierOrganization("Material Supplier Organization"),
        ElectricitySupplierOrganization("Electricity Supplier Organization"),
