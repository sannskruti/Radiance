...
public class ProcessWorkRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(approveJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(543, 327, 115, 36));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Result");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 189, 56, 32));
        ...
        add(resultJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 233, 587, 88));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 330, 82, 31));
        ...
        add(rejectjButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(664, 327, 115, 36));

        jLabel2.setFont(new java.awt.Font("Cambria", 1, 36)); // NOI18N
        jLabel2.setText("Micro Credit  Request - Processing");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(176, 55, 670, -1));
    ...
    private void approveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveJButtonActionPerformed
        ...
        request.setStatus("Client Check - Approved");
        JOptionPane.showMessageDialog(null,"Client Check Approved","INFO",JOptionPane.INFORMATION_MESSAGE);
        backJButtonActionPerformed(evt);
    ...
    private void rejectjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rejectjButton1ActionPerformed
        ...
        request.setTestResult(resultJTextField.getText());
        request.setStatus("Client Check - Rejected");
        JOptionPane.showMessageDialog(null,"Client Check Rejected","INFO",JOptionPane.INFORMATION_MESSAGE);
        backJButtonActionPerformed(evt);
