...
public class ProcessWorkRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(approveJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(585, 427, 141, 51));

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 1, 13)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Add your results:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 239, -1, 34));
        ...
        add(resultJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 291, 646, 104));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(205, 187, -1, 34));
        ...
        add(rejectjButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(754, 427, 108, 51));

        jLabel2.setFont(new java.awt.Font("Cambria", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Bank Client Check - Process");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(224, 85, 638, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/bankbg.jpg"))); // NOI18N
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1190, 890));
    ...
    private void approveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveJButtonActionPerformed
        ...
        SMSUtility.sendSMS("Hi, Your request has been approved.");
        backJButtonActionPerformed(evt);
